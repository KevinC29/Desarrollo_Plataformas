    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        switch(item.getItemId()){
            ...
            case R.id.optionFragmentos:
                intent = new Intent(Activity_Principal.this, ActividadFragmentos.class);
                startActivity(intent);
                break;
            case R.id.opcionDialogo:
                Dialog dialogoLogin = new Dialog(Activity_Principal.this);
                ...
                botonDlg.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Toast.makeText(Activity_Principal.this, cajaUsuario.getText().toString()
            ...
            case R.id.optionPI:
                ...
                break;
            case R.id.optionDS:
                intent = new Intent(Activity_Principal.this, ActivityMemoriaSD.class);
                startActivity(intent);
                break;
            case R.id.optionBD:
                ...
                break;
            case R.id.optionWeb:
                intent = new Intent(Activity_Principal.this, ActivityVolleyAlumno.class);
                startActivity(intent);
            default:
