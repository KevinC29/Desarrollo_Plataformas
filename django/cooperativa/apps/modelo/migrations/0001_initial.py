    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('estadoCivil', models.CharField(choices=[('soltero', 'Soltero'), ('casado', 'Casado'), ('union', 'Unión Libre'), ('divorciado', 'Divorciado'), ('viudo', 'Viudo'), ('separado', 'Separado')], default='soltero', max_length=30)),
